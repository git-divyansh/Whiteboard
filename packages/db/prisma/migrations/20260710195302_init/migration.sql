...
-- CreateEnum
CREATE TYPE "ShareAccess" AS ENUM ('PUBLIC', 'RESTRICTED');

-- CreateEnum
CREATE TYPE "InvitationStatus" AS ENUM ('PENDING', 'ACCEPTED', 'REVOKED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('USER_LOGIN_SUCCESS', 'USER_LOGIN_FAILURE', 'USER_LOGOUT', 'PASSWORD_RESET_REQUESTED', 'PASSWORD_RESET_COMPLETED', 'EMAIL_VERIFIED', 'MFA_ENABLED', 'MFA_DISABLED', 'PERMISSION_CHANGED', 'BOARD_SHARED', 'BOARD_UNSHARED', 'USER_INVITED', 'INVITATION_ACCEPTED', 'ACCOUNT_DELETED');
...
CREATE TABLE "ShareLink" (
    ...
    "boardId" TEXT NOT NULL,
    "token" TEXT NOT NULL,
    "access" "ShareAccess" NOT NULL DEFAULT 'RESTRICTED',
    "role" "Role" NOT NULL DEFAULT 'VIEWER',
    "createdById" TEXT NOT NULL,
